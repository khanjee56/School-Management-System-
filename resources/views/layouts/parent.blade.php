...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="/hr/departments" class="{{ request()->is('hr/departments*') ? 'active' : '' }}">
            <i class="fas fa-building"></i>My child
        </a>

        <a href="/hr/designations" class="{{ request()->is('hr/designations*') ? 'active' : '' }}">
            <i class="fas fa-briefcase"></i> child attendence
        </a>

        <a href="/hr/designations" class="{{ request()->is('hr/designations*') ? 'active' : '' }}">
            <i class="fas fa-briefcase"></i> Child result
        </a>

        <a href="/hr/designations" class="{{ request()->is('hr/designations*') ? 'active' : '' }}">
            <i class="fas fa-briefcase"></i> Notices
        </a>
