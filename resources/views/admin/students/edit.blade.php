...
<div class="card">
    <div class="card-header bg-dark text-white">
        <h5 class="mb-0">✏️ Edit Student — {{ $students->id }}</h5>
    </div>
    <div class="card-body">
        <form action="/admin/students/{{ $students->id }}/update" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
<div class="mb-3">
    ...
    @enderror
            ...
            <div class="d-flex justify-content-between">
                <a href="/admin/students" class="btn btn-outline-dark">← Back</a>
